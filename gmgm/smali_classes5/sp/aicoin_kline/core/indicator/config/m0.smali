.class public final Lsp/aicoin_kline/core/indicator/config/m0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getMfi()Lsp/aicoin_kline/core/indicator/config/MFIRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MFIRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;->getUpperBand()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;->getLowerBand()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MFIRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;->getMfiDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/MFIRemote;
    ...
    new-instance v6, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;
    ...
    invoke-direct {v6, v3, v5, v4}, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v7, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;
    ...
    invoke-direct/range {v7 .. v20}, Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v6, v7}, Lsp/aicoin_kline/core/indicator/config/MFIRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/MFIRemote$Input;Lsp/aicoin_kline/core/indicator/config/MFIRemote$Output;)V
