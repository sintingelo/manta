.class public final Lsp/aicoin_kline/core/indicator/config/s0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getMtm()Lsp/aicoin_kline/core/indicator/config/MtmRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MtmRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/MtmRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MtmRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/MtmRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Output;->getMtmDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Output;->getMaMtmDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/MtmRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Input;
    ...
    invoke-direct {v2, v4, v6}, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v5, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Output;
    ...
    invoke-direct/range {v5 .. v13}, Lsp/aicoin_kline/core/indicator/config/MtmRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/MtmRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/MtmRemote$Input;Lsp/aicoin_kline/core/indicator/config/MtmRemote$Output;)V
    ...
    const v57, -0x40000001    # -1.9999999f
