.class public final Lsp/aicoin_kline/core/indicator/config/h;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getAipd()Lsp/aicoin_kline/core/indicator/config/AiPDRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiPDRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/AiPDRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiPDRemote$Output;->getPdDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/AiPDRemote$Output;
    ...
    invoke-direct/range {v1 .. v11}, Lsp/aicoin_kline/core/indicator/config/AiPDRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/AiPDRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/AiPDRemote$Output;)V
