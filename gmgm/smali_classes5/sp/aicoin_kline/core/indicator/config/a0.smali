.class public final Lsp/aicoin_kline/core/indicator/config/a0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getDmi()Lsp/aicoin_kline/core/indicator/config/DmiRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmiRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/DmiRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Input;->getMac1()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Input;->getMac2()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmiRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;->getPdiDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;->getMdiDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;->getAdxDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;->getAdxrDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/DmiRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Input;
    ...
    invoke-direct {v2, v4, v6}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    invoke-static {v0, v6}, Lsp/aicoin_kline/core/indicator/config/i0;->b(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;I)Z

    move-result v6

    new-instance v7, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;
    ...
    invoke-direct/range {v7 .. v21}, Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v7}, Lsp/aicoin_kline/core/indicator/config/DmiRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/DmiRemote$Input;Lsp/aicoin_kline/core/indicator/config/DmiRemote$Output;)V
