.class public final Lsp/aicoin_kline/core/indicator/config/b0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getEmv()Lsp/aicoin_kline/core/indicator/config/EMVRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/EMVRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/EMVRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Input;->getMac1()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Input;->getMac2()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/EMVRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/EMVRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Output;->getEmvDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Output;->getMaEmvDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/EMVRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Input;
    ...
    invoke-direct {v2, v4, v6}, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v7, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Output;
    ...
    invoke-direct/range {v7 .. v15}, Lsp/aicoin_kline/core/indicator/config/EMVRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v7}, Lsp/aicoin_kline/core/indicator/config/EMVRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/EMVRemote$Input;Lsp/aicoin_kline/core/indicator/config/EMVRemote$Output;)V
