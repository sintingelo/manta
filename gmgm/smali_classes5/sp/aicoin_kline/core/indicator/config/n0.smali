.class public final Lsp/aicoin_kline/core/indicator/config/n0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getMlr()Lsp/aicoin_kline/core/indicator/config/MLRRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MLRRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/MLRRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MLRRemote$Output;->getMlrDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/MLRRemote$Output;
    ...
    invoke-direct/range {v1 .. v6}, Lsp/aicoin_kline/core/indicator/config/MLRRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/MLRRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/MLRRemote$Output;)V
