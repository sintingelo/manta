.class public final Lsp/aicoin_kline/core/indicator/config/g;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getAinetvol()Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote$Output;->getVolDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote$Output;

    const/4 v2, 0x0

    move-object/from16 v7, p0

    invoke-static {v7, v2}, Lsp/aicoin_kline/core/indicator/config/i0;->b(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;I)Z
    ...
    invoke-direct/range {v1 .. v6}, Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/AiNetVolRemote$Output;)V
