.class public final Lsp/aicoin_kline/core/indicator/config/b1;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getSmi()Lsp/aicoin_kline/core/indicator/config/SmiRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SmiRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/SmiRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/SmiRemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SmiRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/SmiRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SmiRemote$Output;->getSmiDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/SmiRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/SmiRemote$Input;
    ...
    invoke-direct {v2, v4}, Lsp/aicoin_kline/core/indicator/config/SmiRemote$Input;-><init>(Ljava/lang/Integer;)V

    new-instance v5, Lsp/aicoin_kline/core/indicator/config/SmiRemote$Output;
    ...
    invoke-direct/range {v5 .. v10}, Lsp/aicoin_kline/core/indicator/config/SmiRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/SmiRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/SmiRemote$Input;Lsp/aicoin_kline/core/indicator/config/SmiRemote$Output;)V
