.class public final Lsp/aicoin_kline/core/indicator/config/j0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getKc()Lsp/aicoin_kline/core/indicator/config/KCRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KCRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/KCRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/KCRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/KCRemote$Input;->getFactor()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KCRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/KCRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KCRemote$Output;->getUpperDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KCRemote$Output;->getMidDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KCRemote$Output;->getLowerDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v7, Lsp/aicoin_kline/core/indicator/config/KCRemote;

    new-instance v1, Lsp/aicoin_kline/core/indicator/config/KCRemote$Input;
    ...
    invoke-direct {v1, v3, v5}, Lsp/aicoin_kline/core/indicator/config/KCRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v5, Lsp/aicoin_kline/core/indicator/config/KCRemote$Output;
    ...
    invoke-direct {v5, v4, v3, v2}, Lsp/aicoin_kline/core/indicator/config/KCRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;)V

    invoke-direct {v7, v1, v5}, Lsp/aicoin_kline/core/indicator/config/KCRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/KCRemote$Input;Lsp/aicoin_kline/core/indicator/config/KCRemote$Output;)V
