.class public final Lsp/aicoin_kline/core/indicator/config/w0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getPsy()Lsp/aicoin_kline/core/indicator/config/PsyRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/PsyRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/PsyRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/PsyRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/PsyRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Output;->getPsyDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Output;->getMaPsyDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/PsyRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Input;
    ...
    invoke-direct {v2, v4, v6}, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v5, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Output;
    ...
    invoke-direct/range {v5 .. v13}, Lsp/aicoin_kline/core/indicator/config/PsyRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/PsyRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/PsyRemote$Input;Lsp/aicoin_kline/core/indicator/config/PsyRemote$Output;)V
...
.method public final onCreateParams()[Lsp/aicoin_kline/core/indicator/config/IndicatorParameter;
    ...
    invoke-direct {v13, v2, v10}, Lkotlin/ranges/IntRange;-><init>(II)V

    const/16 v17, 0x18

    const/16 v18, 0x0

    const-string v12, "MAPSY"
