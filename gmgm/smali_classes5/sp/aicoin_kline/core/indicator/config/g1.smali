.class public final Lsp/aicoin_kline/core/indicator/config/g1;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getTvolume()Lsp/aicoin_kline/core/indicator/config/TVolumeRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/TVolumeRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/TVolumeRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/TVolumeRemote$Output;->getTVolumeDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/TVolumeRemote$Output;
    ...
    invoke-direct/range {v1 .. v6}, Lsp/aicoin_kline/core/indicator/config/TVolumeRemote$Output;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/TVolumeRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/TVolumeRemote$Output;)V
