.class public final Lsp/aicoin_kline/core/indicator/config/q;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getBbi()Lsp/aicoin_kline/core/indicator/config/BBIRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BBIRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;->getN1()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;->getN2()Ljava/lang/Integer;

    move-result-object v2

    const/4 v3, 0x1

    invoke-static {p0, v3, v2}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;->getN3()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;->getN4()Ljava/lang/Integer;

    move-result-object v0

    const/4 v2, 0x3

    invoke-static {p0, v2, v0}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BBIRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/BBIRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Output;->getBbiDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v12, Lsp/aicoin_kline/core/indicator/config/BBIRemote;

    new-instance v1, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;
    ...
    invoke-direct {v1, v3, v4, v5, v6}, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v13, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Output;
    ...
    invoke-direct/range {v13 .. v18}, Lsp/aicoin_kline/core/indicator/config/BBIRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v12, v1, v13}, Lsp/aicoin_kline/core/indicator/config/BBIRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/BBIRemote$Input;Lsp/aicoin_kline/core/indicator/config/BBIRemote$Output;)V
