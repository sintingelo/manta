.class public final Lsp/aicoin_kline/core/indicator/config/x;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getDpo()Lsp/aicoin_kline/core/indicator/config/DPORemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DPORemote;->getInput()Lsp/aicoin_kline/core/indicator/config/DPORemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DPORemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DPORemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DPORemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/DPORemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DPORemote$Output;->getDpoDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DPORemote$Output;->getMaDpoDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/DPORemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/DPORemote$Input;
    ...
    invoke-direct {v2, v4, v6}, Lsp/aicoin_kline/core/indicator/config/DPORemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v7, Lsp/aicoin_kline/core/indicator/config/DPORemote$Output;
    ...
    invoke-direct/range {v7 .. v18}, Lsp/aicoin_kline/core/indicator/config/DPORemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v7}, Lsp/aicoin_kline/core/indicator/config/DPORemote;-><init>(Lsp/aicoin_kline/core/indicator/config/DPORemote$Input;Lsp/aicoin_kline/core/indicator/config/DPORemote$Output;)V
