.class public final Lsp/aicoin_kline/core/indicator/config/k;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getAo()Lsp/aicoin_kline/core/indicator/config/AORemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AORemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/AORemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AORemote$Output;->getAoDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/AORemote$Output;

    const/4 v2, 0x0

    move-object/from16 v9, p0

    invoke-static {v9, v2}, Lsp/aicoin_kline/core/indicator/config/i0;->b(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;I)Z
    ...
    invoke-direct/range {v1 .. v8}, Lsp/aicoin_kline/core/indicator/config/AORemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/AORemote;-><init>(Lsp/aicoin_kline/core/indicator/config/AORemote$Output;)V
