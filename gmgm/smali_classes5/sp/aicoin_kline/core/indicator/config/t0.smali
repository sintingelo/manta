.class public final Lsp/aicoin_kline/core/indicator/config/t0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getObv()Lsp/aicoin_kline/core/indicator/config/ObvRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ObvRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/ObvRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/ObvRemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ObvRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/ObvRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ObvRemote$Output;->getObvDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ObvRemote$Output;->getMaObvDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/ObvRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/ObvRemote$Input;
    ...
    invoke-direct {v2, v4}, Lsp/aicoin_kline/core/indicator/config/ObvRemote$Input;-><init>(Ljava/lang/Integer;)V
    ...
    new-instance v5, Lsp/aicoin_kline/core/indicator/config/ObvRemote$Output;
    ...
    invoke-direct/range {v5 .. v13}, Lsp/aicoin_kline/core/indicator/config/ObvRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/ObvRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/ObvRemote$Input;Lsp/aicoin_kline/core/indicator/config/ObvRemote$Output;)V
