.class public final Lsp/aicoin_kline/core/indicator/config/e1;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getTtmu()Lsp/aicoin_kline/core/indicator/config/TTMURemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/TTMURemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/TTMURemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/TTMURemote$Output;->getLongDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/TTMURemote$Output;->getShortDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/TTMURemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/TTMURemote$Output;
    ...
    invoke-direct/range {v2 .. v10}, Lsp/aicoin_kline/core/indicator/config/TTMURemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2}, Lsp/aicoin_kline/core/indicator/config/TTMURemote;-><init>(Lsp/aicoin_kline/core/indicator/config/TTMURemote$Output;)V
