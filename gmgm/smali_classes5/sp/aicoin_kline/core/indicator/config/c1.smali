.class public final Lsp/aicoin_kline/core/indicator/config/c1;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getStochrsi()Lsp/aicoin_kline/core/indicator/config/StochRSIRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;->getRsiLength()Ljava/lang/Integer;

    move-result-object v3

    invoke-static {p0, v2, v3}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;->getStochLength()Ljava/lang/Integer;

    move-result-object v3

    invoke-static {p0, v1, v3}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;->getK()Ljava/lang/Integer;

    move-result-object v3

    const/4 v4, 0x2

    invoke-static {p0, v4, v3}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;->getD()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;->getUpperBand()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;->getLowerBand()Ljava/lang/Integer;

    move-result-object v0

    const/4 v3, 0x5

    invoke-static {p0, v3, v0}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Output;->getStochRsiDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Output;->getMaStochRsiDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote;
    ...
    invoke-static {v0, v6}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;I)I
    ...
    new-instance v10, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;
    ...
    invoke-direct/range {v10 .. v16}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v11, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Output;
    ...
    invoke-direct/range {v11 .. v27}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Output;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v10, v11}, Lsp/aicoin_kline/core/indicator/config/StochRSIRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Input;Lsp/aicoin_kline/core/indicator/config/StochRSIRemote$Output;)V
...
.method public final onCreateParams()[Lsp/aicoin_kline/core/indicator/config/IndicatorParameter;
    ...
    invoke-direct {v14, v9, v1}, Lkotlin/ranges/IntRange;-><init>(II)V
