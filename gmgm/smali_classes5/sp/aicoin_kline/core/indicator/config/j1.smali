.class public final Lsp/aicoin_kline/core/indicator/config/j1;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getVr()Lsp/aicoin_kline/core/indicator/config/VrRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/VrRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/VrRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/VrRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/VrRemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/VrRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/VrRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/VrRemote$Output;->getVrDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/VrRemote$Output;->getMaVrDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/VrRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/VrRemote$Input;
    ...
    invoke-direct {v2, v4, v6}, Lsp/aicoin_kline/core/indicator/config/VrRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v5, Lsp/aicoin_kline/core/indicator/config/VrRemote$Output;
    ...
    invoke-direct/range {v5 .. v13}, Lsp/aicoin_kline/core/indicator/config/VrRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/VrRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/VrRemote$Input;Lsp/aicoin_kline/core/indicator/config/VrRemote$Output;)V
