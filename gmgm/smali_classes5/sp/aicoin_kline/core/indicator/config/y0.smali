.class public final Lsp/aicoin_kline/core/indicator/config/y0;
...
# virtual methods
.method public final a()[Lsp/aicoin_kline/core/indicator/config/IndicatorParameter;
    .locals 19
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getRsi()Lsp/aicoin_kline/core/indicator/config/RsiRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/RsiRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;->getMac1()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;->getMac2()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;->getMac3()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;->getUpperBand()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;->getLowerBand()Ljava/lang/Integer;

    move-result-object p1

    const/4 v0, 0x4

    invoke-static {p0, v0, p1}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V
...
.method public final b()[Lsp/aicoin_kline/core/indicator/config/r0$a;
    ...
    const-string v3, "RSI1"

    const/4 v5, 0x6

    const/4 v6, 0x1

    invoke-direct {v1, v3, v2, v5, v6}, Lsp/aicoin_kline/core/indicator/config/r0$a;-><init>(Ljava/lang/String;Lkotlin/ranges/IntRange;IZ)V
    ...
    const-string v3, "RSI3"

    const/16 v4, 0x18

    invoke-direct {v1, v3, v2, v4, v6}, Lsp/aicoin_kline/core/indicator/config/r0$a;-><init>(Ljava/lang/String;Lkotlin/ranges/IntRange;IZ)V
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/RsiRemote;
    ...
    new-instance v7, Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;
    ...
    invoke-direct/range {v7 .. v12}, Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V

    const/4 v2, 0x0

    invoke-direct {v1, v7, v2}, Lsp/aicoin_kline/core/indicator/config/RsiRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/RsiRemote$Input;Lsp/aicoin_kline/core/indicator/config/RsiRemote$Output;)V
