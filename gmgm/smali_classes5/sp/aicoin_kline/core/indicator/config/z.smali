.class public final Lsp/aicoin_kline/core/indicator/config/z;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getDma()Lsp/aicoin_kline/core/indicator/config/DmaRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmaRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/DmaRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Input;->getSc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Input;->getLc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmaRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/DmaRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Output;->getDmaDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Output;->getAmaDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/DmaRemote;
    ...
    new-instance v7, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Input;
    ...
    invoke-direct {v7, v5, v6, v3}, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v8, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Output;
    ...
    invoke-direct/range {v8 .. v16}, Lsp/aicoin_kline/core/indicator/config/DmaRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v7, v8}, Lsp/aicoin_kline/core/indicator/config/DmaRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/DmaRemote$Input;Lsp/aicoin_kline/core/indicator/config/DmaRemote$Output;)V
...
.method public final onCreateParams()[Lsp/aicoin_kline/core/indicator/config/IndicatorParameter;
    ...
    invoke-direct {v13, v9, v1}, Lkotlin/ranges/IntRange;-><init>(II)V
