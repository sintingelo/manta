.class public final Lsp/aicoin_kline/core/indicator/config/o;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getAtr()Lsp/aicoin_kline/core/indicator/config/AtrRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AtrRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/AtrRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/AtrRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AtrRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/AtrRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AtrRemote$Output;->getAtrDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/AtrRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/AtrRemote$Input;
    ...
    invoke-direct {v2, v4}, Lsp/aicoin_kline/core/indicator/config/AtrRemote$Input;-><init>(Ljava/lang/Integer;)V

    new-instance v5, Lsp/aicoin_kline/core/indicator/config/AtrRemote$Output;
    ...
    invoke-direct/range {v5 .. v10}, Lsp/aicoin_kline/core/indicator/config/AtrRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/AtrRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/AtrRemote$Input;Lsp/aicoin_kline/core/indicator/config/AtrRemote$Output;)V
