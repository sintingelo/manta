.class public final Lsp/aicoin_kline/core/indicator/config/l0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getLsur()Lsp/aicoin_kline/core/indicator/config/LSURRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/LSURRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/LSURRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/LSURRemote$Output;->getLsurDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/LSURRemote$Output;
    ...
    invoke-direct/range {v1 .. v6}, Lsp/aicoin_kline/core/indicator/config/LSURRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/LSURRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/LSURRemote$Output;)V
