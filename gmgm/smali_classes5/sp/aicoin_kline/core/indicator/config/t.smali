.class public final Lsp/aicoin_kline/core/indicator/config/t;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getBbw()Lsp/aicoin_kline/core/indicator/config/BbwRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BbwRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/BbwRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BbwRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BbwRemote$Input;->getSd()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BbwRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/BbwRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BbwRemote$Output;->getBbwDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/BbwRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/BbwRemote$Input;
    ...
    invoke-direct {v2, v4, v5}, Lsp/aicoin_kline/core/indicator/config/BbwRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v6, Lsp/aicoin_kline/core/indicator/config/BbwRemote$Output;
    ...
    invoke-direct/range {v6 .. v11}, Lsp/aicoin_kline/core/indicator/config/BbwRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v6}, Lsp/aicoin_kline/core/indicator/config/BbwRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/BbwRemote$Input;Lsp/aicoin_kline/core/indicator/config/BbwRemote$Output;)V
