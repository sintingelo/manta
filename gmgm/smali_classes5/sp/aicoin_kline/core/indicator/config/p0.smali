.class public final Lsp/aicoin_kline/core/indicator/config/p0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getMacd()Lsp/aicoin_kline/core/indicator/config/MACDRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MACDRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/MACDRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Input;->getSc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Input;->getLc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Input;->getMac()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MACDRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/MACDRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Output;->getDifDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Output;->getDeaDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Output;->getMacdDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v15, Lsp/aicoin_kline/core/indicator/config/MACDRemote;
    ...
    new-instance v7, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Input;
    ...
    invoke-direct {v7, v4, v6, v2}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v16, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Output;
    ...
    invoke-direct/range {v16 .. v33}, Lsp/aicoin_kline/core/indicator/config/MACDRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    move-object/from16 v1, v16

    invoke-direct {v15, v7, v1}, Lsp/aicoin_kline/core/indicator/config/MACDRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/MACDRemote$Input;Lsp/aicoin_kline/core/indicator/config/MACDRemote$Output;)V
