.class public final Lsp/aicoin_kline/core/indicator/config/e;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getAili()Lsp/aicoin_kline/core/indicator/config/AiLIRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiLIRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/AiLIRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiLIRemote$Output;->getPosDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiLIRemote$Output;->getNegDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/AiLIRemote;
    ...
    new-instance v4, Lsp/aicoin_kline/core/indicator/config/AiLIRemote$Output;
    ...
    invoke-direct/range {v4 .. v12}, Lsp/aicoin_kline/core/indicator/config/AiLIRemote$Output;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v4}, Lsp/aicoin_kline/core/indicator/config/AiLIRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/AiLIRemote$Output;)V
