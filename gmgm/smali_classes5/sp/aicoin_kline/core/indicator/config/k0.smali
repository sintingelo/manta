.class public final Lsp/aicoin_kline/core/indicator/config/k0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getKdj()Lsp/aicoin_kline/core/indicator/config/KDJRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KDJRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/KDJRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Input;->getMac1()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Input;->getMac2()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KDJRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/KDJRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Output;->getKDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Output;->getDDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Output;->getJDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/KDJRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Input;
    ...
    invoke-direct {v2, v4, v6, v8}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v6, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Output;
    ...
    invoke-direct/range {v6 .. v17}, Lsp/aicoin_kline/core/indicator/config/KDJRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v6}, Lsp/aicoin_kline/core/indicator/config/KDJRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/KDJRemote$Input;Lsp/aicoin_kline/core/indicator/config/KDJRemote$Output;)V
