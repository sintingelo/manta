.class public final Lsp/aicoin_kline/core/indicator/config/u0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getPfr()Lsp/aicoin_kline/core/indicator/config/PFRRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/PFRRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/PFRRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/PFRRemote$Output;->getLineDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/PFRRemote$Output;
    ...
    invoke-direct/range {v1 .. v9}, Lsp/aicoin_kline/core/indicator/config/PFRRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/PFRRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/PFRRemote$Output;)V
