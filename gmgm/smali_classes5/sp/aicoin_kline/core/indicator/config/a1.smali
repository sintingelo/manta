.class public final Lsp/aicoin_kline/core/indicator/config/a1;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getSkdj()Lsp/aicoin_kline/core/indicator/config/SkdjRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Input;->getMac1()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Input;->getMac2()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Output;->getKDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Output;->getDDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/SkdjRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Input;
    ...
    invoke-direct {v2, v4, v6, v7}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V
    ...
    new-instance v5, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Output;
    ...
    invoke-direct/range {v5 .. v13}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/SkdjRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Input;Lsp/aicoin_kline/core/indicator/config/SkdjRemote$Output;)V
