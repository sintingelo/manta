.class public final Lsp/aicoin_kline/core/indicator/config/y;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getDc()Lsp/aicoin_kline/core/indicator/config/DCRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DCRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/DCRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/DCRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DCRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/DCRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DCRemote$Output;->getMidDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DCRemote$Output;->getUpperDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/DCRemote$Output;->getLowerDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v4, Lsp/aicoin_kline/core/indicator/config/DCRemote;

    new-instance v1, Lsp/aicoin_kline/core/indicator/config/DCRemote$Input;
    ...
    invoke-direct {v1, v3}, Lsp/aicoin_kline/core/indicator/config/DCRemote$Input;-><init>(Ljava/lang/Integer;)V

    new-instance v5, Lsp/aicoin_kline/core/indicator/config/DCRemote$Output;
    ...
    invoke-direct/range {v5 .. v11}, Lsp/aicoin_kline/core/indicator/config/DCRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v4, v1, v5}, Lsp/aicoin_kline/core/indicator/config/DCRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/DCRemote$Input;Lsp/aicoin_kline/core/indicator/config/DCRemote$Output;)V
