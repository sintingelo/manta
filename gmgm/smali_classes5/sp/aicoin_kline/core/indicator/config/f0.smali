.class public final Lsp/aicoin_kline/core/indicator/config/f0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getFtbs()Lsp/aicoin_kline/core/indicator/config/FTBSRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/FTBSRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/FTBSRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/FTBSRemote$Output;->getBuyDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/FTBSRemote$Output;->getSellDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/FTBSRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/FTBSRemote$Output;
    ...
    invoke-direct/range {v2 .. v10}, Lsp/aicoin_kline/core/indicator/config/FTBSRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2}, Lsp/aicoin_kline/core/indicator/config/FTBSRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/FTBSRemote$Output;)V
