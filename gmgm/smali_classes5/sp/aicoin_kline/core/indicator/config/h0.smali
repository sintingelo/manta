.class public final Lsp/aicoin_kline/core/indicator/config/h0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getIchimoku()Lsp/aicoin_kline/core/indicator/config/IchimokuRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;->getConversionCycle()Ljava/lang/Integer;

    move-result-object v5

    invoke-static {p0, v4, v5}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;->getBaseCycle()Ljava/lang/Integer;

    move-result-object v5

    invoke-static {p0, v3, v5}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;->getLaggingSpan2Cycle()Ljava/lang/Integer;

    move-result-object v5

    invoke-static {p0, v2, v5}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Integer;)V

    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;->getDisplacement()I
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;->getConversionDisabled()Ljava/lang/Boolean;

    move-result-object v0

    invoke-static {p0, v4, v0}, Lsp/aicoin_kline/core/indicator/config/i0;->a(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;ILjava/lang/Boolean;)V

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;->getBaseDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;->getLaggingSpanDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;->getLead1Disabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;->getLead2Disabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v6, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote;

    new-instance v1, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;
    ...
    invoke-direct {v1, v3, v5, v8, v10}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;I)V

    new-instance v11, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;
    ...
    invoke-static {v0, v9}, Lsp/aicoin_kline/core/indicator/config/i0;->b(Lsp/aicoin_kline/core/indicator/config/IndicatorConfig;I)Z
    ...
    invoke-direct/range {v11 .. v16}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/Boolean;)V

    invoke-direct {v6, v1, v11}, Lsp/aicoin_kline/core/indicator/config/IchimokuRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Input;Lsp/aicoin_kline/core/indicator/config/IchimokuRemote$Output;)V
...
.method public final onCreateParams()[Lsp/aicoin_kline/core/indicator/config/IndicatorParameter;
    ...
    const-string v2, "Conversion Line Periods"
    ...
    const-string v12, "Base Line Periods"
    ...
    const-string v13, "Lagging Span 2 Periods"
