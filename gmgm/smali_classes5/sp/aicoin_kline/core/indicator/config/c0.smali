.class public final Lsp/aicoin_kline/core/indicator/config/c0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getEma()Lsp/aicoin_kline/core/indicator/config/EMARemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/EMARemote;->getInput()Lsp/aicoin_kline/core/indicator/config/EMARemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/EMARemote$Input;->getEma()Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/EMARemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/EMARemote$Output;

    move-result-object p1

    if-eqz p1, :cond_4

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/EMARemote$Output;->getEma()Ljava/util/List;
    ...
    check-cast v3, Lsp/aicoin_kline/core/indicator/config/EMARemote$Output$Ema;

    if-eqz v3, :cond_3

    invoke-virtual {v3}, Lsp/aicoin_kline/core/indicator/config/EMARemote$Output$Ema;->getEmaDisabled()Ljava/lang/Boolean;
...
.method public final b()[Lsp/aicoin_kline/core/indicator/config/r0$a;
    ...
    const-string v6, "EMA1"

    const/4 v7, 0x7

    const/4 v8, 0x1

    invoke-direct {v2, v6, v3, v7, v8}, Lsp/aicoin_kline/core/indicator/config/r0$a;-><init>(Ljava/lang/String;Lkotlin/ranges/IntRange;IZ)V
    ...
    new-instance v0, Lsp/aicoin_kline/core/indicator/config/r0$a;

    new-instance v2, Lkotlin/ranges/IntRange;

    invoke-direct {v2, v4, v5}, Lkotlin/ranges/IntRange;-><init>(II)V

    const-string v3, "EMA3"

    const/16 v6, 0x1e

    invoke-direct {v0, v3, v2, v6, v8}, Lsp/aicoin_kline/core/indicator/config/r0$a;-><init>(Ljava/lang/String;Lkotlin/ranges/IntRange;IZ)V
    ...
    const-string v3, "EMA4"

    invoke-direct {v0, v3, v2, v4, v4}, Lsp/aicoin_kline/core/indicator/config/r0$a;-><init>(Ljava/lang/String;Lkotlin/ranges/IntRange;IZ)V
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v6, Lsp/aicoin_kline/core/indicator/config/EMARemote$Output$Ema;
    ...
    invoke-direct/range {v6 .. v11}, Lsp/aicoin_kline/core/indicator/config/EMARemote$Output$Ema;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    :cond_1
    new-instance v14, Lsp/aicoin_kline/core/indicator/config/EMARemote;

    new-instance v0, Lsp/aicoin_kline/core/indicator/config/EMARemote$Input;

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/EMARemote$Input;-><init>(Ljava/util/List;)V

    new-instance v1, Lsp/aicoin_kline/core/indicator/config/EMARemote$Output;

    invoke-direct {v1, v2}, Lsp/aicoin_kline/core/indicator/config/EMARemote$Output;-><init>(Ljava/util/List;)V

    invoke-direct {v14, v0, v1}, Lsp/aicoin_kline/core/indicator/config/EMARemote;-><init>(Lsp/aicoin_kline/core/indicator/config/EMARemote$Input;Lsp/aicoin_kline/core/indicator/config/EMARemote$Output;)V
