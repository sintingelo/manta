.class public final Lsp/aicoin_kline/core/indicator/config/r;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getBrar()Lsp/aicoin_kline/core/indicator/config/BRARRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BRARRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/BRARRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BRARRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BRARRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/BRARRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BRARRemote$Output;->getBrDisabled()Ljava/lang/Boolean;
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BRARRemote$Output;->getArDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/BRARRemote;

    new-instance v2, Lsp/aicoin_kline/core/indicator/config/BRARRemote$Input;
    ...
    invoke-direct {v2, v4}, Lsp/aicoin_kline/core/indicator/config/BRARRemote$Input;-><init>(Ljava/lang/Integer;)V
    ...
    new-instance v5, Lsp/aicoin_kline/core/indicator/config/BRARRemote$Output;
    ...
    invoke-direct/range {v5 .. v13}, Lsp/aicoin_kline/core/indicator/config/BRARRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v2, v5}, Lsp/aicoin_kline/core/indicator/config/BRARRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/BRARRemote$Input;Lsp/aicoin_kline/core/indicator/config/BRARRemote$Output;)V
