.class public final Lsp/aicoin_kline/core/indicator/config/z0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getSar()Lsp/aicoin_kline/core/indicator/config/SARRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SARRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/SARRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/SARRemote$Input;->getAf()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/SARRemote$Input;->getEp()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SARRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/SARRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/SARRemote$Output;->getSarDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v8, Lsp/aicoin_kline/core/indicator/config/SARRemote;

    new-instance v1, Lsp/aicoin_kline/core/indicator/config/SARRemote$Input;
    ...
    invoke-direct {v1, v3, v4}, Lsp/aicoin_kline/core/indicator/config/SARRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v9, Lsp/aicoin_kline/core/indicator/config/SARRemote$Output;
    ...
    invoke-direct/range {v9 .. v14}, Lsp/aicoin_kline/core/indicator/config/SARRemote$Output;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v8, v1, v9}, Lsp/aicoin_kline/core/indicator/config/SARRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/SARRemote$Input;Lsp/aicoin_kline/core/indicator/config/SARRemote$Output;)V
