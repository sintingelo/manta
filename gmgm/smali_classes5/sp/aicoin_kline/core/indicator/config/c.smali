.class public final Lsp/aicoin_kline/core/indicator/config/c;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getAifdi()Lsp/aicoin_kline/core/indicator/config/AiFDIRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiFDIRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/AiFDIRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiFDIRemote$Output;->getFdiDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/AiFDIRemote$Output;
    ...
    invoke-direct/range {v1 .. v11}, Lsp/aicoin_kline/core/indicator/config/AiFDIRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/AiFDIRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/AiFDIRemote$Output;)V
