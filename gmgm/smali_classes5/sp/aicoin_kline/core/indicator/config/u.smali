.class public final Lsp/aicoin_kline/core/indicator/config/u;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getBias()Lsp/aicoin_kline/core/indicator/config/BiasRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BiasRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/BiasRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Input;->getBias()Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BiasRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_4

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output;->getBias()Ljava/util/List;
    ...
    check-cast v3, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output$Bia;

    if-eqz v3, :cond_3

    invoke-virtual {v3}, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output$Bia;->getBiasDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v6, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output$Bia;
    ...
    invoke-direct/range {v6 .. v11}, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output$Bia;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    new-instance v2, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Input;

    invoke-direct {v2, v1}, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Input;-><init>(Ljava/util/List;)V

    new-instance v4, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output;
    ...
    invoke-direct/range {v4 .. v10}, Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output;-><init>(Ljava/util/List;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v2, v4}, Lsp/aicoin_kline/core/indicator/config/BiasRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/BiasRemote$Input;Lsp/aicoin_kline/core/indicator/config/BiasRemote$Output;)V

    new-instance v6, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
