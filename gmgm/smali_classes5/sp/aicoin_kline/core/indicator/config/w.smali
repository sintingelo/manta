.class public final Lsp/aicoin_kline/core/indicator/config/w;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getCci()Lsp/aicoin_kline/core/indicator/config/CCIRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/CCIRemote;->getInput()Lsp/aicoin_kline/core/indicator/config/CCIRemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Input;->getCc()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Input;->getUpperBand()Ljava/lang/Integer;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Input;->getLowerBand()Ljava/lang/Integer;
    ...
    :cond_1
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/CCIRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/CCIRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Output;->getCciDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/CCIRemote;
    ...
    new-instance v6, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Input;
    ...
    invoke-direct {v6, v3, v5, v4}, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Input;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v7, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Output;
    ...
    invoke-direct/range {v7 .. v20}, Lsp/aicoin_kline/core/indicator/config/CCIRemote$Output;-><init>(Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v1, v6, v7}, Lsp/aicoin_kline/core/indicator/config/CCIRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/CCIRemote$Input;Lsp/aicoin_kline/core/indicator/config/CCIRemote$Output;)V
...
.method public final onCreateParams()[Lsp/aicoin_kline/core/indicator/config/IndicatorParameter;
    ...
    invoke-direct {v12, v1, v2}, Lkotlin/ranges/IntRange;-><init>(II)V
    ...
    invoke-direct {v13, v1, v2}, Lkotlin/ranges/IntRange;-><init>(II)V
