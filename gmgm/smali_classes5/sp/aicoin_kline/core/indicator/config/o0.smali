.class public final Lsp/aicoin_kline/core/indicator/config/o0;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getMa()Lsp/aicoin_kline/core/indicator/config/MARemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MARemote;->getInput()Lsp/aicoin_kline/core/indicator/config/MARemote$Input;
    ...
    invoke-virtual {v0}, Lsp/aicoin_kline/core/indicator/config/MARemote$Input;->getMa()Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MARemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/MARemote$Output;

    move-result-object p1

    if-eqz p1, :cond_4

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/MARemote$Output;->getMa()Ljava/util/List;
    ...
    check-cast v3, Lsp/aicoin_kline/core/indicator/config/MARemote$Output$Ma;

    if-eqz v3, :cond_3

    invoke-virtual {v3}, Lsp/aicoin_kline/core/indicator/config/MARemote$Output$Ma;->getMaDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v6, Lsp/aicoin_kline/core/indicator/config/MARemote$Output$Ma;
    ...
    invoke-direct/range {v6 .. v11}, Lsp/aicoin_kline/core/indicator/config/MARemote$Output$Ma;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    :cond_1
    new-instance v13, Lsp/aicoin_kline/core/indicator/config/MARemote;

    new-instance v0, Lsp/aicoin_kline/core/indicator/config/MARemote$Input;

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/MARemote$Input;-><init>(Ljava/util/List;)V

    new-instance v1, Lsp/aicoin_kline/core/indicator/config/MARemote$Output;

    invoke-direct {v1, v2}, Lsp/aicoin_kline/core/indicator/config/MARemote$Output;-><init>(Ljava/util/List;)V

    invoke-direct {v13, v0, v1}, Lsp/aicoin_kline/core/indicator/config/MARemote;-><init>(Lsp/aicoin_kline/core/indicator/config/MARemote$Input;Lsp/aicoin_kline/core/indicator/config/MARemote$Output;)V
