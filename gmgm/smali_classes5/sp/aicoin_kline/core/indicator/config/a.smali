.class public final Lsp/aicoin_kline/core/indicator/config/a;
...
.method public final applyRemoteConfig(Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;)V
    ...
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;->getAibsi()Lsp/aicoin_kline/core/indicator/config/AiBsiRemote;
    ...
    :cond_0
    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiBsiRemote;->getOutput()Lsp/aicoin_kline/core/indicator/config/AiBsiRemote$Output;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lsp/aicoin_kline/core/indicator/config/AiBsiRemote$Output;->getBsiDisabled()Ljava/lang/Boolean;
...
.method public final exportRemoteConfig()Lsp/aicoin_kline/core/indicator/config/ChartIndicatorSetting;
    ...
    new-instance v1, Lsp/aicoin_kline/core/indicator/config/AiBsiRemote$Output;
    ...
    invoke-direct/range {v1 .. v11}, Lsp/aicoin_kline/core/indicator/config/AiBsiRemote$Output;-><init>(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/Integer;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {v0, v1}, Lsp/aicoin_kline/core/indicator/config/AiBsiRemote;-><init>(Lsp/aicoin_kline/core/indicator/config/AiBsiRemote$Output;)V
