.class public final Lsp/aicoin_kline/core/indicator/provider/c1;
...
.method public final b(Lsp/aicoin_kline/core/indicator/a;)V
    ...
    invoke-static {v1, v0}, Lsp/aicoin_kline/calculation/moving_calculation/common/k;->a(ILjava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v0, v0, v3}, Lsp/aicoin_kline/calculation/moving_calculation/common/l;->a(Ljava/util/List;Ljava/util/List;Ljava/util/List;I)Ljava/util/ArrayList;

    move-result-object v0

    invoke-static {p1, v0}, Lsp/aicoin_kline/util/n;->a(ILjava/util/List;)Ljava/util/List;

    move-result-object v0

    new-instance v1, Lsp/aicoin_kline/calculation/moving_calculation/common/i;

    invoke-direct {v1}, Lsp/aicoin_kline/calculation/moving_calculation/common/i;-><init>()V

    invoke-virtual {v1, v0, v5, v4}, Lsp/aicoin_kline/calculation/moving_calculation/h;->a(Ljava/util/List;IZ)Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v0, v6, v4}, Lsp/aicoin_kline/calculation/moving_calculation/h;->a(Ljava/util/List;IZ)Ljava/util/ArrayList;
